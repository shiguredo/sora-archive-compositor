...
/// severity ごとに行全体を色付けする tracing の Formatter 実装
struct Formatter {
    ansi: bool,
}
...
mod tests {
    ...
    fn civil_from_days_unix_epoch() {
        // 1970-01-01 (エポックからの日数 0 日目)
        assert_eq!(civil_from_days(0), (1970, 1, 1));
    }

    #[test]
    fn civil_from_days_known_dates() {
        // 2024-04-03 (閏年 4 月の平日、境界条件確認)
        assert_eq!(civil_from_days(19816), (2024, 4, 3));
        // 2000-01-01 (400 年周期の年初、Howard Hinnant アルゴリズムの era 境界)
        assert_eq!(civil_from_days(10957), (2000, 1, 1));
        // 2026-04-03 (実運用に近い最近の日付)
