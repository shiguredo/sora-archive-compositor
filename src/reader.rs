...
impl AudioReader {
    ...
    pub fn new(
        ...
        let first_input_file = remaining_input_files
            .pop()
            .ok_or_else(|| crate::Error::new("no input files"))?;
        let inner = match format {
            ContainerFormat::Mp4 => {
                ...
                AudioReaderInner::Mp4(Mp4AudioReader::new(
                    source_id.clone(),
                    first_input_file,
                    stats,
                )?)
            ...
            ContainerFormat::Webm => {
                ...
                AudioReaderInner::Webm(WebmAudioReader::new(
                    source_id.clone(),
                    first_input_file,
                    stats,
                )?)
    ...
    pub fn new(
        ...
        let inner = match format {
            ContainerFormat::Mp4 => {
                ...
                VideoReaderInner::Mp4(Box::new(Mp4VideoReader::new(
                    source_id.clone(),
                    first_input_file,
                    stats,
                )?))
            ...
            ContainerFormat::Webm => {
                ...
                VideoReaderInner::Webm(Box::new(WebmVideoReader::new(
                    source_id.clone(),
                    first_input_file,
                    stats,
                )?))
